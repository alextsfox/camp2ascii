...
from camp2ascii.ingest import ingest_tob3_data, ingest_tob2_data


def main(path: Path | str) -> pd.DataFrame:
    ...
    if header.file_type in (FileType.TOB3, FileType.TOB2):
        ...
        for i in range(nframes):
            ...
            timestamps[i*header.data_nlines:(i+1)*header.data_nlines] = np.arange(
                beg_timestamp, beg_timestamp + header.data_nlines*header.rec_intvl*1_000_000_000, 
