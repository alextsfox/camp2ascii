...
from .pipeline import execute_config, build_config
...
def camp2ascii(
    ...
    time_interval: datetime.timedelta | str | None, optional
        ...
        Setting this value to an extremely long interval (e.g. 100 years) will result in all matching files being concatenated together.
    ...
    output_format: int, optional
        ...
        4: Output as a pickled pandas dataframe
        5: Output as Pandas DataFrames (not written to disk)
